...
const services = [
  {
    ...
    description: "Custom websites and applications to showcase your research and engage with your audience.",
    features: [
  ...
  },
  {
    icon: Database,
    title: "Data Analysis",
    description: "Transform complex research data into meaningful insights and visualizations.",
    features: [
      "Data Visualization",
  ...
  },
  {
    icon: Users,
    title: "Public Impact",
    description: "Strategic solutions to amplify your research visibility and influence.",
    features: [
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
            Comprehensive solutions tailored to enhance your research impact and visibility
          </p>
        </div>
        ...
        >
          <div className="flex flex-col items-center justify-between gap-4 text-center lg:flex-row lg:text-left">
            <div>
              <h2 className="text-2xl font-bold">Ready to amplify your research impact?</h2>
